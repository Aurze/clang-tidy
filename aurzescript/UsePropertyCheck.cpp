//===--- UsePropertyCheck.cpp - clang-tidy----------------------------===//
//
...
void UsePropertyCheck::registerMatchers(MatchFinder *Finder) {
...
void UsePropertyCheck::warnOnUnusedParameter(
...
void UsePropertyCheck::check(const MatchFinder::MatchResult &Result) {
